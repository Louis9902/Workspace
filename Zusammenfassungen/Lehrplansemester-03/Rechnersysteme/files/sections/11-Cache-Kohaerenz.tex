...
\centering
\includestandalone[width=0.8\linewidth]{./graphics/Cache-Kohaerenz/Abbildung-1}
{\small\textit{Zustandsübergänge des initiierenden Prozessors}}
\includestandalone[width=0.8\linewidth]{./graphics/Cache-Kohaerenz/Abbildung-2}
...
\begin{minipage}{\linewidth}
\centering
\includestandalone[width=0.8\linewidth]{./graphics/Cache-Kohaerenz/Abbildung-3}
{\small\textit{Zustandsübergänge des initiierenden Prozessors}}
\includestandalone[width=0.8\linewidth]{./graphics/Cache-Kohaerenz/Abbildung-4}
{\small\textit{Zustandsübergänge des passiven Prozessors}}
\end{minipage}
...
\begin{minipage}{\linewidth}
\centering
\includestandalone[width=0.7\linewidth]{./graphics/Cache-Kohaerenz/Abbildung-7}
{\small\textit{Zustandsübergänge des initiierenden Prozessors}}
\includestandalone[width=0.7\linewidth]{./graphics/Cache-Kohaerenz/Abbildung-8}
{\small\textit{Zustandsübergänge des passiven Prozessors}}
\end{minipage}
