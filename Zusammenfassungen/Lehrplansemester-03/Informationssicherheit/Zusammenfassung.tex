...
\begin{multicols*}{4}
	...
	\subsubsection{Zwischenschritt}
	Einen Zwischenschritt zwischen Kollisionsresistenz und Einwegeigenschaft
	stellt die Ziel Kollisionsresistenz \emph{(second preimage resistance)} dar,
	dass bedeutet das es praktisch unmöglich ist zu einem gegebenen Eingabewert
	\(x\) einen davon verschieden Eingabewert \(x'\) zu finden, der den selben
	Hashwert ergibt. \[x \neq x',\; h(x) = h(x')\]
