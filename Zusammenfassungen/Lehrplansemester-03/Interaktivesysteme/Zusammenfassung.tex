...
\begin{multicols*}{4}
	...
	\end{description}
	\begin{center}
		\includegraphics[width=0.9\linewidth]{./Documents/Graphics/SeeheimModel.png}
	\end{center}
	...
	\end{description}
	\begin{center}
		\includegraphics[width=0.6\linewidth]{./Documents/Graphics/DiagramPAC.pdf}
	\end{center}
	...
	\end{description}
	\begin{center}
		\includegraphics[width=0.8\linewidth]{./Documents/Graphics/DiagramMVC.pdf}
	\end{center}
	...
	\paragraph{Potel}
	\begin{center}
		\includegraphics[width=0.8\linewidth]{./Documents/Graphics/DiagramMVPPotel.pdf}
	\end{center}
	\paragraph{Fowler}
...
\begin{multicols*}{3}
	...
	\subsection{Menüs}
	\lstinputlisting{Documents/Programs/Menues.xaml}
\end{multicols*}
\end{document}
