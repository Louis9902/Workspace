...
\begin{multicols*}{3}
	...
	\lstinputlisting{software/example.xaml}
	\lstinputlisting{software/example.cs}
	\subsection{Events}
	\lstinputlisting{software/events.xaml}
	\lstinputlisting{software/events.cs}
	...
	\lstinputlisting{software/attribute_1.xaml}
	\lstinputlisting{software/attribute_2.xaml}
	\subsection{Bindings}
	...
	\lstinputlisting{software/data_context.cs}
	\lstinputlisting{software/data_context.xaml}
	\subsubsection{INotifyPropertyChanged}
	\lstinputlisting{software/notify_property.cs}
	\subsection{Style Templates}
	\lstinputlisting{software/styles.xaml}
	\subsection{Triggers und Validation}
	\lstinputlisting{software/triggers.xaml}
	\lstinputlisting{software/validation.xaml}
\end{multicols*}
\end{document}
